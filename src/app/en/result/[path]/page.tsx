  ...
  return (
    <main className="min-h-screen max-w-3xl mx-auto px-6 py-12">
      <div className="flex justify-between items-center mb-6">
        <Link href="/en" className="text-charcoal/40 text-sm hover:text-charcoal transition-colors">
          ← Back
        </Link>
      ...
      <div className="text-center mb-12">
        <Link
          href={`/en/result/${path.slug}/plan?path=${path.slug}`}
      ...
      {/* Restart */}
      <div className="text-center">
        <Link href="/en/quiz" className="text-charcoal/40 text-sm hover:text-charcoal transition-colors">
          Take the quiz again
        </Link>
      </div>
    </main>
